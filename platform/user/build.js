...
/***/ function(module, exports, __webpack_require__) {
	...
	var _bugList = __webpack_require__(44);
	
	var _bugList2 = _interopRequireDefault(_bugList);
	
	var _bugInfo = __webpack_require__(50);
	
	var _bugInfo2 = _interopRequireDefault(_bugInfo);
	
<<<<<<< HEAD
	var _submitBug = __webpack_require__(55);
	
	var _submitBug2 = _interopRequireDefault(_submitBug);
	
	var _companyList = __webpack_require__(60);
	...
	var _bugSummary = __webpack_require__(71);
	...
	var _signIn = __webpack_require__(79);
=======
	var _submitBug = __webpack_require__(54);
	
	var _submitBug2 = _interopRequireDefault(_submitBug);
	
	var _companyList = __webpack_require__(59);
	...
	var _bugSummary = __webpack_require__(70);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  var id = "/Users/mcdong/Graduation-Project/platform/src/components/main.vue"
	  if (!module.hot.data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js?sourceMap!./../../node_modules/vue-loader/lib/style-rewriter.js!./../../node_modules/less-loader/index.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./main.vue", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js?sourceMap!./../../node_modules/vue-loader/lib/style-rewriter.js!./../../node_modules/less-loader/index.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./main.vue");
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/Users/mcdong/Graduation-Project/platform/src/components/bugList.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js?sourceMap!./../../node_modules/vue-loader/lib/style-rewriter.js!./../../node_modules/less-loader/index.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./bugList.vue", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js?sourceMap!./../../node_modules/vue-loader/lib/style-rewriter.js!./../../node_modules/less-loader/index.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./bugList.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
	...
	exports.default = {
	  ...
	  methods: {
	    getBugList: function getBugList() {
	      ...
	      this.$http({ url: '/post/bugList', method: 'POST', data: data }).then(function (response) {
...
<<<<<<< HEAD
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src/components/bugInfo.vue: named exports in *.vue files are ignored.")}
...
>>>>>>> c95cd5ef73f5fcb91b06b2cfbb5c68132867499b
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/Users/mcdong/Graduation-Project/platform/src/components/bugInfo.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports) {
	...
	exports.default = {
	  ...
	  methods: {
	    getBugInfo: function getBugInfo(id) {
	      var t = this;
	      var data = {
	        id: id
	      };
	      this.$http({ url: '/post/bugDetail', method: 'POST', data: data }).then(function (response) {
	        var data = response.data;
	        if (data.error == 0) {
...
>>>>>>> c95cd5ef73f5fcb91b06b2cfbb5c68132867499b
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/Users/mcdong/Graduation-Project/platform/src/components/submitBug.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
>>>>>>> c95cd5ef73f5fcb91b06b2cfbb5c68132867499b
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/Users/mcdong/Graduation-Project/platform/src/components/companyList.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = "\n<div class=\"company-list\">\n  <a href=\"http://www.tjut.edu.cn/\" target=\"view_window\" class=\"logo\"><img src=\"" + __webpack_require__(65) + "\" alt=\"天津理工大学\"></a>\n</div>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = "\n<div class=\"company-list\">\n  <a href=\"http://www.tjut.edu.cn/\" target=\"view_window\" class=\"logo\"><img src=\"" + __webpack_require__(64) + "\" alt=\"天津理工大学\"></a>\n</div>\n";
...
>>>>>>> c95cd5ef73f5fcb91b06b2cfbb5c68132867499b
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/Users/mcdong/Graduation-Project/platform/src/components/userList.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
<<<<<<< HEAD
	      var t = this;
	      this.$http({ url: '/post/useList', method: 'POST' }).then(function (response) {
	        var data = response.data;
	        if (data.error == 0) {
	          t.items = data.data;
	          for (var x in t.items) {
...
>>>>>>> c95cd5ef73f5fcb91b06b2cfbb5c68132867499b
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/Users/mcdong/Graduation-Project/platform/src/components/bugSummary.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
>>>>>>> c95cd5ef73f5fcb91b06b2cfbb5c68132867499b
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src/components/signUp.vue: named exports in *.vue files are ignored.")}
<<<<<<< HEAD
...
>>>>>>> c95cd5ef73f5fcb91b06b2cfbb5c68132867499b
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/Users/mcdong/Graduation-Project/platform/src/components/signUp.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
>>>>>>> c95cd5ef73f5fcb91b06b2cfbb5c68132867499b
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js?sourceMap!./../../node_modules/vue-loader/lib/style-rewriter.js!./../../node_modules/less-loader/index.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./signUp.vue", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js?sourceMap!./../../node_modules/vue-loader/lib/style-rewriter.js!./../../node_modules/less-loader/index.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./signUp.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
	...
	exports.default = {
	  ...
	  methods: {
	    signUp: function signUp() {
	      ...
	      this.$http({ url: '/post/register', method: 'POST', data: data }).then(function (response) {
	        var data = response.data;
	        if (data.error == 0) {
	          this.$router.go({ name: "SignIn" });
	        } else {
...
>>>>>>> c95cd5ef73f5fcb91b06b2cfbb5c68132867499b
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/Users/mcdong/Graduation-Project/platform/src/components/signIn.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
>>>>>>> c95cd5ef73f5fcb91b06b2cfbb5c68132867499b
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js?sourceMap!./../../node_modules/vue-loader/lib/style-rewriter.js!./../../node_modules/less-loader/index.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./signIn.vue", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js?sourceMap!./../../node_modules/vue-loader/lib/style-rewriter.js!./../../node_modules/less-loader/index.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./signIn.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
	  ...
	  methods: {
	    signIn: function signIn() {
	      ...
	      if (t.uid && t.pwd) {
	        ...
	        this.$http({ url: '/post/login', method: 'POST', data: data }).then(function (response) {
	          var data = response.data;
	          if (data.error != 0) {
	            alert(data.content);
	          } else {
